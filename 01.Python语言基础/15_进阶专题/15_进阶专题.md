...
- `08_调试与性能分析/`
  pdb、logging、timeit、cProfile、pytest 覆盖率

- `09_IO扩展/`
  StringIO/BytesIO、struct、gzip/zipfile

- `06_多线程与多进程/高级并发技巧.md`
  threading.local、multiprocessing.Pool 进阶
- `07_异步编程入门/asyncio进阶.md`
  gather、超时、取消
- `05_网络编程基础/网络客户端进阶.md`
  urllib/requests/httpx Mock、超时重试
